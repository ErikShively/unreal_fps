...
void AFPSCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	//PlayerInputComponent->BindAction("Fire", IE_Pressed, this, &AFPSCharacter::MoveCustom);

	PlayerInputComponent->BindAction("Jet", IE_Pressed, this, &AFPSCharacter::MoveJet);
	PlayerInputComponent->BindAction("Jet", IE_Released, this, &AFPSCharacter::MoveJetRelease);

	PlayerInputComponent->BindAction("Dash", IE_Pressed, this, &AFPSCharacter::MoveDash);
	PlayerInputComponent->BindAction("Dash", IE_Released, this, &AFPSCharacter::MoveDashRelease);

	PlayerInputComponent->BindAction("Crouch", IE_Pressed, this, &AFPSCharacter::MoveCrouch);
	PlayerInputComponent->BindAction("Crouch", IE_Released, this, &AFPSCharacter::MoveCrouchRelease);
...
void AFPSCharacter::MoveJet()
{
	UMyCharacterMovementComponent* mc = Cast<UMyCharacterMovementComponent>(GetCharacterMovement());
	mc->bWantsToJet = true;
}

void AFPSCharacter::MoveJetRelease()
{
	UMyCharacterMovementComponent* mc = Cast<UMyCharacterMovementComponent>(GetCharacterMovement());
	mc->bWantsToJet = false;
}

void AFPSCharacter::MoveDash()
{
	UMyCharacterMovementComponent* mc = Cast<UMyCharacterMovementComponent>(GetCharacterMovement());
	mc->bWantsToDash = true;
}

void AFPSCharacter::MoveDashRelease()
{
	UMyCharacterMovementComponent* mc = Cast<UMyCharacterMovementComponent>(GetCharacterMovement());
	mc->bWantsToDash = false;
}

void AFPSCharacter::MoveCrouch()
{
	UMyCharacterMovementComponent* mc = Cast<UMyCharacterMovementComponent>(GetCharacterMovement());
	mc->bWantsToCrouch = true;
}

void AFPSCharacter::MoveCrouchRelease()
{
	UMyCharacterMovementComponent* mc = Cast<UMyCharacterMovementComponent>(GetCharacterMovement());
